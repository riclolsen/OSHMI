...
The modifications introduced are meant only to allow the use of the sotware as a 
  SCADA Synoptics Editor.
...
User interface can be used on:
 - IOS 7+ devices.
 - Android 4.1+ devices.
 - Any device with an HTML5 browser like Chrome, Firefox, Opera or Safari.
...
Notes for version 5.6:

Webserver:
 - Replaced Indy HTTP server with a new one based on the GNU Libmicrohttpd (DLL).
...
QTester104:
 ...
 - Much improved network performance.
...
Screen Viewer:
 ...
 - Fixed problem with center of rotatation (for "rotate" attribute).
...
Linux: 
 ...
 - Referece Linux distribuition is now Mint 19.0 XFCE 32bits.
...
Other:
 ...
 - Improvments to OData and JSON exporters for SQLite.
